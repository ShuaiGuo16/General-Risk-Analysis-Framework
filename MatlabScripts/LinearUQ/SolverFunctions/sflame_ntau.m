...
function H = sflame_ntau(mesh, index, dim, l, flame, omega_comp, thin)

% Number of rows where flame is applied
n = 3;
flame.gain=flame.gain*1.346;
flame.phase=flame.tau*omega_comp;
...
scale = (flame.gamma-1)*flame.qref/(flame.rhoref*flame.uref)*flame.gain*exp(1i*flame.phase);
