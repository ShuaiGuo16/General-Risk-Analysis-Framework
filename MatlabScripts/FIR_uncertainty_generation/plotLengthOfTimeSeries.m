...
% modelPSD_A contains both reference FIR model (truncated, only save the first 65 coefficients) 
% and colored noise model
load('./data/modelPSD_A.mat')
newTF = modelPSD_A;
newTF.u = modelPSD_A.u;
newTF.y = modelPSD_A.y;
...
[data_timeseries,SNR,noise_var] = generateData(sys,dataInput,uEx,noiseEx,uPrimeName,qPrimeName,modelPSD_A);
plot(data_timeseries)
% save './data/data4SysID_A.mat' data_timeseries